      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            {categories.length} categories · Products & Services
          </p>
        </div>
        <Link
          ...
          >
            <div className="flex items-start justify-between">
              <div className="text-2xl">
                {cat.type === CategoryType.SERVICE ? "🔧" : "⚙️"}
              </div>
            ...
            <div className="flex items-center justify-between mt-4 text-sm">
              <span className="text-gray-500">{cat._count.products} items</span>
              <span
                className={`px-2 py-0.5 rounded-full text-xs ${cat.isActive ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-600"}`}
              >
